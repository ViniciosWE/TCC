...
@section('content')
    ...
    <div class="container">
        ...
        <form action="{{ route('campeonatos.store') }}" method="POST">
            ...
            <div class="mb-3">
                <label for="minimo_jogadores_equipes" class="form-label">Mínimo de jogadores por equipe</label>
                <input type="number" class="form-control" id="minimo_jogadores_equipes" name="minimo_jogadores_equipes"
                    value="{{ old('minimo_jogadores_equipes') }}" min="5" required>
            </div>
            {{-- Máximo equipes --}}
            <div class="mb-3">
                <label for="maximo_equipes" class="form-label">Quantidade máxima de equipes</label>
                <input type="number" class="form-control" id="maximo_equipes" name="maximo_equipes"
